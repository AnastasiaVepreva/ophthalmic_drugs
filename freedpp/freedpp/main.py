...
from freedpp.env.reward import Reward, PatternFilter, OutOfRange, identity, Corneal, Melanin, Irritation
...
def init_rewards(args):
    ...
    costs = {
        ...
        'Corneal': Reward(Corneal, OutOfRange(lower=5, hard=hard), preprocess=preprocess),
        'Melanin': Reward(Melanin, OutOfRange(lower=0.9, upper=1.0, hard=hard), preprocess=preprocess),
